...
dependencies {
    ...
    implementation("com.johnturkson.aws-tools:aws-dynamodb-object-builder:0.0.7")
    implementation("com.johnturkson.aws-tools:aws-dynamodb-request-builder:0.0.7")
    implementation("com.johnturkson.aws-tools:aws-dynamodb-transforming-serializer:0.0.7")
    implementation("com.johnturkson.aws-tools:aws-request-signer:0.0.7")
